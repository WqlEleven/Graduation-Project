...
//		echo $id;		
  ...
  <div class="main">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-4">
          <form action="editcate_del.php" method="post">
            <h2>修改栏目</h2>
            <div class="form-group">
              <label for="id">ID</label>
              <input id="id" class="form-control" readonly name="id" type="text" value="<?php echo $result['cate_id']?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <input id="icon" class="form-control" name="icon" type="text" value="<?php echo $result['cate_icon']?>">
             ...
             <div class="form-group">
              ...
              <input id="state"  name="state" type="radio"value="2" >禁止       
              	...
              	<input id="state"  name="state" type="radio"value="2" checked>禁止  	
              	<?php }?>     
            </div>
             <div class="form-group">
