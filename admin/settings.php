...
<body>
    ...
    <div class="container-fluid">
      ...
      <form class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-6">
            ...
            <label class="form-image">
              ...
              <img src="../assets/img/logo.png" id="sitesrc">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <div class="checkbox">
              <label><input id="comment_status" name="comment_status" type="checkbox" checked="checked">开启评论功能</label>
            </div>
            <div class="checkbox">
  ...
  <script>
  	$.ajax({
  		type:'post',
  		url:"http://www.alishow.com/admin/api/site/getSite.php",
  		dataType:'json',
  		success:function(data){
//			console.log(data);
  			if(data.code == 400){
				$('#site_name').val(data.data.site_name);
  				$('#site_description').val(data.data.site_desc);
  				$('#site_keywords').val(data.data.site_keys);
  				$('#sitesrc').attr('src',data.data.site_logo);	
  			}
  		}
  	});
...
//			data:fd,
//			type:"post",
//			url:"http://www.alishow.com/admin/api/site/setSite.php",
//			dataType:'json',
//			success:function(data){
//				console.log(data);
//			}
